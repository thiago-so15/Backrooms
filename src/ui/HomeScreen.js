export class HomeScreen {
  ...
  _build() {
    ...
    const compatWarning = hasFinePointer
      ? ''
      : '<p class="home-compat-warning home-reveal home-reveal--compat" role="note">Este juego necesita mouse y teclado</p>';
  ...
  _handleEnter() {
    ...
    const timeout = setTimeout(finish, 380);
